      ...
      {steps.map((step, index) => {
        ...
        return (
          <TabsTrigger
            key={step.id}
            value={step.id}
            className="flex min-w-0 flex-1 flex-col items-center gap-2 whitespace-normal rounded-lg border-none bg-transparent px-2 py-1.5 text-center focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring data-[state=active]:border-transparent data-[state=active]:bg-transparent"
          >
